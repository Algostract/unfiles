		...
		<div class="container mx-auto px-4 py-6">
			...
			<div class="flex items-center justify-between gap-3">
				...
				<div class="flex items-center gap-2">
					...
					<button type="button"
						...
						aria-label="Toggle theme" title="Toggle theme" @click="toggleDark">
					...
					<button type="button"
						class="inline-flex h-8 items-center justify-center gap-2 rounded-md bg-neutral-900 px-3 text-sm font-medium text-white hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200"
			...
			<div class="mt-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
				<div class="flex items-center gap-3">
					...
					<select v-model="sort"
						class="w-40 h-8 rounded-md border border-neutral-200 bg-white px-2 text-sm text-neutral-700 outline-none ring-0 focus:border-neutral-300 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100">
				...
				<div class="flex items-center gap-3">
					...
					<label class="relative block">
						...
						<input v-model="query" type="text" placeholder="Search Media Library"
					...
					<div class="flex overflow-hidden rounded-md border border-neutral-200 dark:border-neutral-700">
						...
						]" aria-label="Grid view" title="Grid view" @click="view = 'grid'">
							<Icon name="lucide:layout-grid" class="h-4 w-4" />
						</button>
						<button type="button" :class="[
							'inline-flex h-8 w-9 items-center justify-center text-neutral-600 hover:bg-neutral-50 dark:text-neutral-200 dark:hover:bg-neutral-700',
							view === 'list' ? 'bg-neutral-100 dark:bg-neutral-700' : 'bg-transparent'
						]" aria-label="List view" title="List view" @click="view = 'list'">
