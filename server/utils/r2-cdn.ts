...
const r2CdnClientSingleton = () => {
  return new AwsClient({
    accessKeyId: process.env.NUXT_PRIVATE_R2_ACCESS_KEY_ID!,
    secretAccessKey: process.env.NUXT_PRIVATE_R2_SECRET_ACCESS_KEY!,
    service: 's3',
    region: process.env.NUXT_PRIVATE_R2_REGION || 'auto',
  })
}
